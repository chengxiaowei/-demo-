...
define(function(require, exports, module) {
    ...
    //import public lib
    var $ = require('jquery');
    var _jsonp = require('app/js/jquery.json');require('pub/plugins/login-dialog');
    ...
    SmashingEggs.prototype = {
        defaultSetting: {
            ...
            imgSrc : 'http://static5.bubugao.com/mall/topic/2014/10/eggs/img/eggs/flower-bg.png',//图片src
            eggsNum : '3'//金蛋的数量
        },
        init: function() {
            var self = this;
        ...
        setChance : function( num, callback ){
            ...
            if(num!=undefined){
                ...
                var isLog =$.cookie('_nick');
                if(isLog!=null){
                    self.ajax(self.setChanceUrl, {}, function(data){
                        data && $(self.chanceSelector).html( data.prizeRemaining );
                        callback && callback();
                    });
                }
            }

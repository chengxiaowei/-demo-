	...
	$.extend(prototype, {
		...
		_getTypeHtml : function(html) {
			...
			case 'ok':
				...
				break;
			case 'loading-text':
				strIcon = '<img src="//s1.bbgstatic.com/pub/img/loading/loading32x32.gif" />';
				break;
			defaults: strIcon = 'null';
			strHtml = '';
			break;
		}
		...
		if (strIcon.length > 0) {
			...
			var strCSS = 'ui-dialog-type ui-dialog-tips ui-dialog-warning ui-dialog-question ui-dialog-error ui-dialog-ok ui-dialog-loading ui-dialog-null';

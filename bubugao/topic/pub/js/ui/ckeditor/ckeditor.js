...
(function() {
	//设置全局路径
	CKEDITOR_BASEPATH = "//static5.bubugao.com/public/js/ckeditor/";
			...
			fire: function() {
				...
				return function(n, h, i) {
					...
					if (m) {
						var s = m.listeners;
						if (s.length)
							for (var s = s.slice(0), x, q = 0; q < s.length; q++) {
								if (m.errorProof) try {
									x = s[q].call(this,
										i, h, d, b)
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			buildStyleHtml: function(a) {
				for (var a = [].concat(a), d, e = [], b = 0; b < a.length; b++)
					if (d = a[b]) /@import|[{}]/.test(d) ? e.push("<style>" + d + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + d + '">');
				return e.join("")
			},
			...
			normalizeCssText: function(a, d) {
				var e = [],
					b, c = CKEDITOR.tools.parseCssText(a, true, d);
			...
			checkIfAnyArrayItemMatches: function(a, d) {
				for (var e = 0, b = a.length; e < b; ++e)
					if (a[e].match(d)) return true;
				return false
			},
			checkIfAnyObjectPropertyMatches: function(a, d) {
				for (var e in a)
					if (e.match(d)) return true;
				return false
			},
			...
			var b = this.$.cloneNode(a),
				f = function(d) {
					...
					if (d.nodeType == CKEDITOR.NODE_ELEMENT) {
						...
						if (a)
							for (var d = d.childNodes, e = 0; e < d.length; e++) f(d[e])
					}
				};
			f(b);
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
		...
		getByAddress: function(a, c) {
			for (var b = this.$.documentElement, f =
				...
				var d = a[f];
				if (c)
					for (var e = -1, g = 0; g < b.childNodes.length; g++) {
			...
			removeStyle: function(a) {
				...
				if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
					...
					for (var b = [], h = 0; h < c.length; h++)
						if (f)
							for (var i = 0; i < f.length; i++) b.push([a, c[h], f[i]].join("-"));
			...
			copyAttributes: function(a, b) {
				for (var c = this.$.attributes, b = b || {}, f = 0; f < c.length; f++) {
					var h = c[f],
						...
						m;
					if (!(i in b))
						if (i == "checked" && (m = this.getAttribute(i))) a.setAttribute(i, m);
	...
	(function() {
		function a(a, b) {
			...
			if (this.current) d = this.current[v](false, j, k);
				...
				if (a) d.type ==
					CKEDITOR.NODE_ELEMENT && (d = m > 0 ? d.getChild(m - 1) : k(d, true) === false ? null : d.getPreviousSourceNode(true, j, k));
				else {
					d = e;
		...
		function b(a) {
			...
			if (a.type == CKEDITOR.NODE_ELEMENT) {
				...
				if (b = !CKEDITOR.env.needsBrFiller)
					if (b = a.is(m)) a: {
						b = 0;
						for (var d = a.getChildCount(); b < d; ++b)
							if (!i(a.getChild(b))) {
								b = false;
								break a
							}
		...
		var f = function(a) {
			...
			d = function(a, b, d, c) {
				...
				for (d = j; d < g.length; d++) {
					...
					if (!u[d] || i.$.parentNode != u[d].$.parentNode)
			...
			createBookmark2: function() {
				function a(b) {
					...
					if (d.type == CKEDITOR.NODE_TEXT) {
						e = d;
						for (f = 0;
							(e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT;) f = f + e.getLength();
						c = c + f
					}
					b.container = d;
					b.offset = c
			...
			enlarge: function(a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
							...
							for (; j;) {
								...
								if (j.type == CKEDITOR.NODE_COMMENT) j = j.getPrevious();
									...
									if (j.type == CKEDITOR.NODE_TEXT) {
										...
										0 || b && j.is("br")) && !j.data("cke-bookmark"))
										if (g && CKEDITOR.dtd.$removeEmpty[j.getName()]) {
											h = j.getText();
											if (c.test(h)) j = null;
											else
												for (var n = j.$.getElementsByTagName("*"), F = 0, D; D = n[F++];)
						...
						if (r.type == CKEDITOR.NODE_TEXT)
							if (CKEDITOR.tools.trim(r.substring(n)).length) g = true;
							else {
								g = !r.getLength();
								if (n == r.getLength()) {
			...
			shrink: function(a, b, d) {
				if (!this.collapsed) {
					...
					if (e && e.type == CKEDITOR.NODE_TEXT)
						if (u)
							if (u >= e.getLength()) c.setStartAfter(e);
							else {
								c.setStartBefore(e);
								k = 0
							} else c.setStartBefore(e); if (f && f.type == CKEDITOR.NODE_TEXT)
						if (g)
							if (g >= f.getLength()) c.setEndAfter(f);
							else {
								c.setEndAfter(f);
								l = 0
	...
	(function() {
		...
		function f(a, b, c) {
			if (!a.match || a.match(b)) {
				...
				b = b.classes;
				if (a) {
					for (var e = false, f = a === true, o = b.length; o--;)
						if (f || a(b[o])) {
							b.splice(o, 1);
							e =
								true
		...
		function x(a, b, d, e) {
			...
			if (e.doCallbacks && a.elementCallbacks) {
				a: for (var l = a.elementCallbacks, g = 0, r = l.length, y; g < r; ++g)
					if (y = l[g](b)) {
						k = y;
						break a
					}
			...
			if (e.doTransform)
				if (k = a._.transformations[b.name]) {
					s(b);
		...
		function j(a, b, d) {
			var c = a.name;
			if (F.$empty[c] || !a.children.length)
				if (c == "hr" && b == "br") a.replaceWith(k());
				else {
					a.parent && d.push({
						check: "it",
						el: a.parent
						...
						a: {
							...
							if (o)
								for (v = 0; v < o.length; ++v)
									if ((r = c.match(o[v])) && r[0].length == c.length) {
										d = true;
										break a
									}
			...
			check: function(a, b, d) {
				...
				if (CKEDITOR.tools.isArray(a)) {
					for (var c = a.length; c--;)
						if (this.check(a[c], b, d)) return true;
					return false
				}
				var e, f;
				if (typeof a == "string") {
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, c, b) {
			...
			CKEDITOR.scriptLoader.load(e, function(a, d) {
				...
				for (var e = 0; e < a.length; e++)
					for (var q = g[a[e]], o = 0; o < q.length; o++) {
						var u = q[o];
						n[u] = this.get(u);
						f[u] = 1
					}
				...
				g = function(b) {
					a.call(this, b, function(a) {
						...
						for (n in a) {
							...
							if (!c[n]) {
								if (p.icons)
									for (var x = p.icons.split(","), q = x.length; q--;) CKEDITOR.skin.addIcon(x[q], p.path + "icons/" + (CKEDITOR.env.hidpi && p.hidpi ? "hidpi/" : "") + x[q] + ".png");
								c[n] = 1
							}
							if (s) {
								s.split && (s = s.split(","));
		...
		function m(a) {
			...
			CKEDITOR.plugins.load(d.split(","), function(d) {
				...
				CKEDITOR.scriptLoader.load(f, function() {
					for (var d = ["beforeInit", "init", "afterInit"], f = 0; f < d.length; f++)
	...
	(function() {
					...
					if (a(e)) u.push(e);
						...
						if (d == "pre") j = true;
							...
							for (;;) {
								...
								if (!e.isUnknown && !k.isUnknown && !o[d])
									if (k.isOptionalClose) q.onTagClose(g);
									else if (d in b && g in b) {
									g = k.children;
									(g = g[g.length - 1]) && g.name == "li" || p(g = new CKEDITOR.htmlParser.element("li"), k);
									!e.returnPoint && (e.returnPoint = k);
									k = g
								} else if (d in CKEDITOR.dtd.$listItem && !x(d, g)) q.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
								else if (g in c && !x(d, g)) {
									!e.returnPoint && (e.returnPoint = k);
									k = k.parent
								} else {
		...
		CKEDITOR.htmlParser.fragment.prototype = {
			...
			forEach: function(a, b, d) {
				...
				if (c !== false)
					for (var d = this.children, f = 0; f < d.length; f++) {
						c = d[f];
	...
	(function() {
		function a(a, c) {
				...
				return function(c) {
					if (c.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var j = [],
							...
							o, g;
						if (k)
							for (r(k, 1) && j.push(k); k;) {
								if (e(k) && (o = f(k)) && r(o))
									if ((g = f(o)) && !e(g)) j.push(o);
									else {
										l(v).insertAfter(o);
										o.remove()
									}
						...
						if (j = (typeof d == "function" ? d(c) : d) !== false)
							if (!v && !CKEDITOR.env.needsBrFiller &&
								c.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false;
			...
			function r(a, b) {
				...
				if (a.type == CKEDITOR.NODE_TEXT && (d = a.value.match(u))) {
					...
					if (!v)
						if ((d = a.previous) && d.name == "br" || !d || e(d)) return true
				}
				return false
			}
			var w = {
		...
		function o(a, b) {
			for (var d = [], c = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {
				id: 1
			}), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, c = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(c), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) {
		...
		var u = /(?:&nbsp;|\xa0)$/,
			...
			j = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block),
			v = {
				elements: {
					input: n,
					textarea: n
	...
	(function() {
		...
		CKEDITOR.inlineAll = function() {
			...
			for (b in CKEDITOR.dtd.$editable)
				for (var f = CKEDITOR.document.getElementsByTag(b), d = 0, e = f.count(); d < e; d++) {
					a = f.getItem(d);
					if (a.getAttribute("contenteditable") == "true") {
						c = {
							element: a,
					...
					if (this.insertElementIntoRange(a, d)) {
						...
						if (e)
							if ((e = a.getNext(function(a) {
								...
								d.moveToElementEditStart(e) : d.moveToElementEditEnd(a);
		...
		var x = function() {
				...
				return function(h, m, q) {
					...
					if (!s.checkReadOnly()) {
						...
						for (;
							(C = a(p.startContainer) && p.startContainer.getChild(p.startOffset - 1)) && a(C) && C.isBlockBoundary() && E.contains(C);) p.moveToPosition(C, CKEDITOR.POSITION_BEFORE_END);
							...
							for (j(E, G); t < E.length; t++) {
								...
								if (B) w = t > 0;
									...
									if (U) {
										...
										U = 0
									} else G.insertNode(y.node); if (y.lastNotAllowed && t < E.length - 1) {
						...
						for (U = K.createBookmark(); H = m.zombies.pop();)
							if (H.getParent()) {
								Q = K.clone();
						...
						if (T)
							for (; H = T.pop();) CKEDITOR.env.needsBrFiller ? H.appendBogus() : H.append(K.document.createText(" "));
	...
	(function() {
			...
			if (b.collapsed) {
				...
				for (p.getPosition(n) == CKEDITOR.POSITION_FOLLOWING && (p = 0); p;) {
					...
					if (p.equals(n)) {
						...
						if (o && j && CKEDITOR.dtd.$block[s])
							for (var v = p, A = f(v), D = void 0, I = A.length, O = 0, v = I && new CKEDITOR.dom.range(v.getDocument()); O < I; ++O) {
								var D = A[O],
						...
						if (A)
							if ((A = p.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[e] || h) && (!g.parentRule || g.parentRule(A))) {
								...
								if (s == CKEDITOR.NODE_TEXT || o || s == CKEDITOR.NODE_ELEMENT && !p.getChildCount()) {
									for (var s = p, P;
										(i = !s.getNext(F)) && (P = s.getParent(), k[P.getName()]) && (P.getPosition(l) | J) == J && (!g.childRule || g.childRule(P));) s = P;
									q.setEndAfter(s)
								}
							} else i = true;
						else i = true;
						...
						for (var i = u(this, d), o = i.hasAttributes(), r = q.getCommonAncestor(), s = {}, A = {}, D = {}, I = {}, V, R, Y; i && r;) {
							if (r.getName() == e) {
								...
								for (R in g.styles)
									if (!D[R] && (Y = r.getStyle(R))) i.getStyle(R) == Y ? s[R] = 1 : D[R] = 1
							}
							r = r.getParent()
						}
		...
		function s(a, b) {
			var c = this._.definition,
				...
				g;
			for (g in d)
				if (!((g == "class" || this._.definition.fullMatch) && a.getAttribute(g) != j(g, d[g])) && !(b && g.slice(0, 5) == "data-")) {
					f = a.hasAttribute(g);
					a.removeAttribute(g)
				}
			for (var h in c)
				if (!(this._.definition.fullMatch && a.getStyle(h) != j(h, c[h], true))) {
					f = f || !!a.getStyle(h);
					a.removeStyle(h)
				}
			q(a, e, I[a.getName()]);
...
*/
	...
	(function() {
		...
		var u = CKEDITOR.dom.walker.whitespaces(),
			v = CKEDITOR.dom.walker.bookmark();
		CKEDITOR.plugins.enterkey = {
			enterBlock: function(c, e, b, h) {
				if (b = b || r(c)) {
					var f = b.document,
						i = b.checkStartOfBlock(),
						k = b.checkEndOfBlock(),
						j = c.elementPath(b.startContainer),
						a = j.block,
					...
					if (i && k) {
						if (a && (a.is("li") || a.getParent().is("li"))) {
							...
							var h = !a.hasPrevious(),
								...
								m = d.getDirection(1) != i,
								c = c.enterMode != CKEDITOR.ENTER_BR || m || o || k;
							if (d.is("li"))
								if (h || n) a[h ? "insertBefore" : "insertAfter"](d);
								else a.breakParent(d);
							else {
								if (c)
									if (j.block.is("li") ? (d = f.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), m && d.setAttribute("dir", i), o && d.setAttribute("style", o), k && d.setAttribute("class",
										k), a.moveChildren(d)) : d = j.block, h || n) d[h ? "insertBefore" : "insertAfter"](b);
									else a.breakParent(b), d.insertAfter(b);
								else if (a.appendBogus(!0), h || n)
									for (; f = a[h ? "getFirst" : "getLast"]();) f[h ? "insertBefore" : "insertAfter"](b);
								else
			...
			enterBr: function(c, e,
				...
				if (b = b || r(c)) {
					var f = b.document,
						i = b.checkEndOfBlock(),
						k = new CKEDITOR.dom.elementPath(c.getSelection().getStartElement()),
						j = k.block,
						a = j && k.block.getName();
	...
	(function() {
		function k(a) {
			...
			} catch (g) {}(CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == d.document.$.compatMode) && this.attachListener(this,
				"keydown", function(a) {
					var b = a.data.getKeystroke();
					if (b == 33 || b == 34)

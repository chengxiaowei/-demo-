 ...
 * kfuin: kfuin
 * type: wpa style type { 1-9 button styles || b1-b4 float styles 锝�
        ...
        var css = function() {
            var getStyle = document.defaultView && document.defaultView.getComputedStyle ?
                    // for standard W3C method
                            function(node, style) {
                                //font-wight鑰岄潪fontWight
                                style = style.replace(/([A-Z])/g, "-$1").toLowerCase();

                                //鑾峰彇鏍峰紡瀵硅薄骞惰幏鍙栧睘鎬э紙瀛樺湪鐨勮瘽锛夊€�
...
//            currentScript = script;
                ...
                var Panel = function() {
                    ...
                    var SETTINGS = {
                        ...
                        cssText: [
                            ...
                            '.WPA-CONFIRM-BUTTON { position:relative; display:inline-block!important; display:inline; zoom:1; min-width:62px; height:22px; margin:0 0 0 5px; padding:0 4px; background:none; line-height:22px; color:#234864; text-decoration:none; font-size:12px; text-align:center;}',
                            ...
                            '.WPA-CONFIRM-BUTTON-PADDING { position:absolute; left:0; top:0; display:inline-block!important; display:inline; zoom:1; width:4px; height:22px; background:none;}',
                ...
                (function() {
                    ...
                    var settings = {
                        'a01': {
                            templ: ['<div id="wpa_release_a01" class="wpa_release_a01 btn btn-sec c-fav">',
                                    '<a id="launchBtn" href="javascript:;">',
                                    '<i class="icon iconfont" style="color:#FF9900">&#xe638;</i><span style="color:#666">在线客服</span></a></div>'].join(''),
                            script: 'js/wpa_a01',
                            style: 'css/wpa',
                        ...
                        'a03': {
                            ...
                            style: 'css/wpa',
                            init: function(context, helper) {
                                context.getElementById('launchBtn').innerHTML = '\u533F\u540D\u4EA4\u8C08'; //鍖垮悕浜よ皥
                                helper.getOnlineStatus();
                        ...
                        'i01': {
                            templ: [
                                ...
                                '<a id="wpa_release_i01_confirmBtn" class="wpa_release_i01_confirmBtn" href="javascript:;">' + '\u5F00\u59CB\u4EA4\u8C08' + '</a>', //寮€濮嬩氦璋�
                                '<p id="cnt" class="cnt">' + '\u60A8\u597D\uFF0C\u8BF7\u6709\u4EC0\u4E48\u53EF\u4EE5\u5E2E\u5230\u60A8\uFF1F\u8BF7\u63A5\u53D7\u804A\u5929\u9080\u8BF7\u3002' + '</p>', //鎮ㄥソ锛岃闂湁浠€涔堝彲浠ュ府鍒版偍锛熻鎺ュ彈鑱婂ぉ閭€璇枫€�
                                '<div id="closeBtn" class="closeBtn"></div>',
                                '</div>'
                            ].join(''),
                            script: 'js/wpa_i01',
                    ...
                    ViewHelper.prototype = {
                        ...
                        onLoad: onLoad,
                        /**
                         * 涓婃姤Performance timing鏁版嵁锛�
                         * 濡傛灉鏌愪釜鏃堕棿鐐硅姳璐规椂闂翠负0锛屽垯姝ゆ椂闂寸偣鏁版嵁涓嶄笂鎶ャ€�
                         *
                         * @param {String}
                         *            f1 flag1绠€鍐欙紝娴嬮€熺郴缁熶腑鐨勪笟鍔D锛岃濡傛牎鍙嬩笟鍔′负164
                         *
                         * @param {String}
                         *            f2 flag2绠€鍐欙紝娴嬮€熺殑绔欑偣ID
                         *
                         * @param {String}
                         *            f3_ie flag3绠€鍐欙紝娴嬮€熺殑椤甸潰ID
                         *锛堝洜涓轰娇鐢ㄨ繃绋嬩腑鎴戜滑鍙戠幇IE9鐨勬煇浜涙暟鎹瓨鍦ㄥ紓甯革紝
                         * 濡傛灉IE9鍜宑hrome鍚堝苟缁熻锛屼細褰卞搷鍒嗘瀽缁撴灉锛屾墍浠ヨ繖閲屽缓璁垎寮€缁熻锛�
                         *
                         * @param {String}
                         *            f3_c flag3绠€鍐欙紝娴嬮€熺殑椤甸潰ID
                         * 锛堝鏋滀负绌猴紝鍒橧E9鍜宑hrome鍚堝苟缁熻锛�
                         *
                         */
                        setTimingRpt: function(f1, f2, f3_ie, f3_c) {
                            ...
                            if (_p && (_t = _p.timing)) {
                                ...
                                if (window.d0) {//缁熻椤甸潰鍒濆鍖栨椂鐨刣0鏃堕棿
                    ...
                    WPAManager = {
                        ...
                        getParams: function() {
                            ...
                            //缁熻椤甸潰鏉ユ簮
                            //闀垮害杩囬暱闇€瑕佹埅鏂紝閬垮厤瓒呰繃娴忚鍣ㄥ拰鏈嶅姟鍣ㄩ檺鍒�
                        ...
                        invite: function(di, params) {
                            if (!di) {
                                //銆愭偍鏈夋柊娑堟伅銆� utf-8缂栫爜锛� 鑻ヤ笉杞爜锛屽湪闈瀠tf-8椤甸潰浼氬紩璧蜂贡鐮�
                                titleFlash.on('\u3010\u60A8\u6709\u65B0\u4FE1\u606F\u3011');
                    ...
                    WPA.prototype = {
                        ...
                        render: function() {
                            ...
                            //涓氬姟鍒嗗彂鍣紝鍔ㄦ€佸姞杞藉綋鍓嶆牱寮忔墍闇€鐨勪笟鍔s
                            var width, height,
                        ...
                        createWPA: function(onCreate) {
                            ...
                            (function() {
                                ...
                                var loaded = function() {
                                    ...
                                    Style.load('style', 'http://static5.bubugao.com/public/css/wpa.' + (GREY ? 'grey.' : '') + 'css?v=' + VERSION, {context: iDoc});
                        ...
                        /**
                         * 娴姩WPA鐨刬frame鍔犺浇鍣紝鍒ゆ柇鐩爣椤甸潰鍔犺浇鎴愬姛鍚庡啀show鍑烘潵
                         */
                        initFloatWPA: function() {
                            ...
                            function initIframeLoad() {
                                ...
                                //瀵笽E6杩涜鐗规畩澶勭悊position:absolute锛岀敤setInterval瀹炵幇婊氬姩璺熼殢
                        ...
                        launchChat: function() {
                            this.getConfig(proxy(this, function() {
                                ...
                                getQQVersion(function(version) {
                                    ...
                                    new Panel({
                                        title: '\u53D1\u8D77\u4F1A\u8BDD\u63D0\u793A', //鍙戣捣浼氳瘽鎻愮ず
                                        content: '\u62B1\u6B49\uFF01\u65E0\u6CD5\u68C0\u6D4B\u5230\u60A8\u7535\u8111\u662F\u5426\u5B89\u88C5QQ\uFF0C\u8BF7\u60A8\u786E\u8BA4\u4EE5\u4FBF\u76F4\u63A5\u5411\u4F01\u4E1A\u53D1\u8D77\u4F1A\u8BDD\u3002', //鎶辨瓑锛佹棤娉曟娴嬪埌鎮ㄧ數鑴戞槸鍚﹀畨瑁匭Q锛岃鎮ㄧ‘璁や互渚跨洿鎺ュ悜浼佷笟鍙戣捣浼氳瘽銆�
                                        buttons: [
                                            {
                                                isFocus: true,
                                                text: 'QQ\u5DF2\u5B89\u88C5\uFF0C\u70B9\u51FB\u4F1A\u8BDD', //QQ宸插畨瑁咃紝鐐瑰嚮浼氳瘽
                                                events: {
                                                    click: function() {
                                                        this.remove();
                                                        wpa.launchAIOChat();
                                            ...
                                            {
                                                text: '\u672A\u5B89\u88C5\uFF0C\u53D1\u8D77\u7F51\u9875\u4F1A\u8BDD', //鏈畨瑁咃紝鍙戣捣缃戦〉浼氳瘽
                                                events: {
                                                    click: function() {
                                                        this.remove();
                ...
                (function() {
                    ...
                    Master.prototype = {
                        ...
                        initWithConfig: function() {
                            /*
                             r	閿欒鐮侊紝0-鎴愬姛锛屽叾浠�-澶辫触
                             isAuto	鏄惁寮€鍚嚜鍔ㄩ個璇风殑寮€鍏筹紝0-鍏炽€�1-寮€
                             autoTime	鑷姩閭€璇风殑鏃堕棿锛岃秴杩囪鏃堕棿涓斿紑鍏冲紑鐨勬儏鍐典笅锛屽彂璧烽個璇�
                             gap	涓嬫蹇冭烦鐨勬椂闂撮棿闅旓紝濡傛灉涓虹┖浣跨敤榛樿鏃堕棿
                             inviteState	鏄惁鏈変富鍔ㄩ個璇凤紝 0-鏈個璇枫€�1-鍙戣捣閭€璇枫€�2-宸查個璇�
                             */
                            var cfg = this.config;
 ...
 * 1.澧炲姞browser宸ュ叿
 * 2.鏀瑰杽鐐瑰嚮
 * 3.淇wpa_i01.js鐨刋SS婕忔礊
 * 4.灞曠ず閫昏緫閲嶆瀯
 * 5.鐐瑰嚮鑱婂ぉ閫昏緫閲嶆瀯
 * 6.瀹氬埗鎺ュ彛瀹炵幇淇敼
 * 7.澧炲姞VERSION銆丏EBUG鍜孏REY甯搁噺
 * 8.澧炲姞鐗堟湰妫€鏌ュ拰鑷姩娓呴櫎缂撳瓨
 * 9.淇敼WPA椤甸潰娴嬮€熶唬鐮�
 *
 */
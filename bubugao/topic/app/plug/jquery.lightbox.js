		...
		*/
		...
		function doChangeImage() {
			...
			function resizeImageContainer(imgWidth, imgHeight) {
				...
				var wDiff = opts.widthCurrent - widthNew;
				var hDiff = opts.heightCurrent - heightNew;
		...
		$.fn.lightbox.defaults = {
		  triggerEvent: "click",
			allSet: false,
			fileLoadingImage: '//static5.bubugao.com/mall/topic/public/img/lightbox/loading.gif',
			fileBottomNavCloseImage: '//static5.bubugao.com/mall/topic/public/img/lightbox/closelabel.gif',
			overlayOpacity: 0.6,
			borderSize: 10,
